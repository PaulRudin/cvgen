...
acquisition and ingestion, and high performance scoring and ranking
functionality utilising Python/Cython and Numpy, which is made available for
front end applications via Graphql subscriptions. Components are mostly
implemented in Python, but some use Node.js. Front end applications are
implemented in Flutter (Dart) and are available in the Google Play Store and
Apple App Store.
